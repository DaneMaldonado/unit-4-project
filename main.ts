...
function moonOutlineFunction5 () {
    for (let index2 = 0; index2 < 3; index2++) {
        moonOutline = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
...
function ChooseItems () {
    ...
    if (index == 1) {
        treeOutlineFunction2()
    }
    if (index == 2) {
        skierOutlineFunction2()
    }
    if (index == 3) {
        roadOutlineFunction()
    }
    if (index == 4) {
        moonOutlineFunction5()
    }
}
function roadOutlineFunction () {
    for (let index2 = 0; index2 < 3; index2++) {
        roadOutline = sprites.create(img`
...
function planeOutlineFunction () {
    for (let index2 = 0; index2 < 3; index2++) {
        planeOutline = sprites.create(img`
            ...
            ...........7777777........
            `, SpriteKind.Player)
        planeOutline.setPosition(134, 12)
        pause(250)
        sprites.destroy(planeOutline)
        pause(250)
    }
    planeOutline = sprites.create(img`
        ....77777777.......77777..
...
function skierOutlineFunction2 () {
    for (let index2 = 0; index2 < 3; index2++) {
        skierOutline = sprites.create(img`
            ....77777777777.
            ...77.....7...77
            ..77...........7
            ..7............7
            ...
            ................
            `, SpriteKind.Player)
        skierOutline.setPosition(141, 41)
        pause(250)
        sprites.destroy(skierOutline)
        pause(250)
    }
    skierOutline = sprites.create(img`
        ....77777777777.
...
let planeOutline: Sprite = null
let roadOutline: Sprite = null
let moonOutline: Sprite = null
...
let skier = sprites.create(img`
    ...
    `, SpriteKind.Player)
skier.scale = 0.8
skier.setPosition(141, 41)
let road = sprites.create(img`
    ...
    
